    ...
    getInfoEmbed(id, msg) {
        return new Promise(async (fulfill, reject) => {
          try{
            ...
            // console.log(info);
            embed.setAuthor('Misaki nHentai Generator', this.client.nHlogo);
        ...
        return new Promise(async (fulfill, reject) => {
          try {
            ...
            forwards.on('collect', async f => {
                ...
                read.setAuthor('Misaki - Read Hentai', this.client.nHlogo);
            ...
            download.on('collect', d => {
                ...
                msg.author.send(`Fufufu,\n${res.title.pretty}\nhttps://nhentai.net/g/${res.id}`);
                msg.author.send('Enjoy the sauce~');
